...
#! documentation in the function reference chapter (Chapter
#! <Ref Chap="Chapter_funcref"/>) for details, but examples are given in
#! this chapter.
#!
...
#!
#! The sections below describe how to communicate, using
#! <Ref Func="CreateVisualization"/>, with each of the visualization tools
...
#!
#! As the documentation linked to in Section <Ref Sect="Section_tooldocs"/>
